...
public class FilterArticlesActivity extends AppCompatActivity implements RecyclerView.OnScrollChangeListener  {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            loadIntoListView(filterJsonArray(array,categ));
    ...
    private JSONArray filterJsonArray(JSONArray array,String categ) throws JSONException {

            JSONArray newArray=new JSONArray();
        for (int i = 0; i < array.length(); ++i) {

            String cat = array.getJSONObject(i).getString("categTitle");
            if(categ!="Filtered Articles")
            if (cat.equals(categ)) {
